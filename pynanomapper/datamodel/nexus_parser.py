...
class NexusParser:
    ...
    def parse_h5(self,h5_file):
        try:
            def iterate_groups(group, indent=''):
                nx_class = group.attrs.get('NX_class', None)
